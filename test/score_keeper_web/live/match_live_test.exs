defmodule ScoreKeeperWeb.MatchLiveTest do
  use ScoreKeeperWeb.ConnCase

  import Phoenix.LiveViewTest
  import ScoreKeeper.MatchesFixtures

  @create_attrs %{played_at: "2024-11-11T22:59:00"}
  @update_attrs %{played_at: "2024-11-12T22:59:00"}
